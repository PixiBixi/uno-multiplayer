...
# this code still runs on; .nvmrc is the version CI actually lints, covers and runs the
# browser suite against, so it is the one thing production should match. They
