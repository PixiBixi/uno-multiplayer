...
describe('Seven-Zero on the wire', () => {
  it(
    ...
    async () => {
      const { players } = await table({ liar: false, sevenZero: true })
  ...
  it(
    ...
    async () => {
      const { host } = await table({ liar: false, sevenZero: true })
  ...
  it(
    ...
    async () => {
      const { players } = await table({ liar: false, sevenZero: false })
