...
const PLAIN: TableRules = { liar: false, sevenZero: false }
const SEVEN_ZERO: TableRules = { liar: false, sevenZero: true }
/** Both options at once, which is the only way a swap can open an UNO window. */
const WATCHED: TableRules = { liar: true, sevenZero: true }
